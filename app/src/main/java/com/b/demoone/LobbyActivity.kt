...
import com.b.demoone.R
import com.b.demoone.FirebaseData.myID
...
class LobbyActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listView: ListView = this.findViewById(R.id.list)
    ...
    private fun init() {
        ...
        val txtLogout: TextView = findViewById(R.id.txt_logout)


        txtLogout.setOnClickListener {
            //FirebaseAuth.getInstance().signOut()
            val usersRef = FirebaseData.database.getReference("users")
            usersRef.child("users/${myID}/online").onDisconnect().setValue(false)
